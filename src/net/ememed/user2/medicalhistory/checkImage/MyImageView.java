...
public class MyImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (width > CheckImageActivity.screenWidth) {
		// 如果图宽大于屏宽，就不用水平居中
		center(false, true);
		} else {
		center(true, true);
	...
	private void arithScaleRate() {
		float scaleWidth = CheckImageActivity.screenWidth / (float) imageWidth;
		float scaleHeight = CheckImageActivity.screenHeight / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		//缩放到屏幕大小
		zoomTo(scaleRate,CheckImageActivity.screenWidth / 2f, CheckImageActivity.screenHeight / 2f);
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = CheckImageActivity.screenWidth - width;
		float fill_height = CheckImageActivity.screenHeight - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( CheckImageActivity.screenWidth/2f)/imageWidth;
