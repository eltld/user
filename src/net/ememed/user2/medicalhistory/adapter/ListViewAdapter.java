...
public class ListViewAdapter extends BaseAdapter {
	...
	public ListViewAdapter(ArrayList<ArrayList<String>> mList,
	...
	public void change(ArrayList<ArrayList<String>> mList, ArrayList<String> listItems, ArrayList<String> times) {
		if (mList == null) {
			mList = new ArrayList<ArrayList<String>>();
		}
		if (listItems == null) {
