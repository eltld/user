...
public class FirstConsult {
	...
	public void setEXT(ExtensionEn eXT) {
		EXT = eXT;
	}
	...
	public UserInfoEn getUSER_INFO() {
		return USER_INFO;
	}
	public void setUSER_INFO(UserInfoEn uSER_INFO) {
		USER_INFO = uSER_INFO;
	}
