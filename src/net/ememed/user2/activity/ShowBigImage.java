...
import net.ememed.user2.task.LoadLocalBigImgTask;
import net.ememed.user2.util.ImageCache;
import net.ememed.user2.widget.photoview.PhotoView;
...
public class ShowBigImage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (uri != null && new File(uri.getPath()).exists()) {
			...
			maps.put("Authorization", "Bearer "+EMChatConfig.getInstance());
			...
			image.setImageBitmap(showBitmap);
		} else {
