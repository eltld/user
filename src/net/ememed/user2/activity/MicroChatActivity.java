...
import net.ememed.user2.fragment.MicroChatFragment;
...
public class MicroChatActivity extends BasicActivity implements OnClickListener{
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.activity_microchat);
		...
		bundle_chat.putSerializable("memberInfo", memberInfo);
