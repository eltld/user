...
public class BaseAdapterHelper {
	...
	/**
	 * This method allows you to retrieve a view and perform custom operations on it, not covered by
	 * the BaseAdapterHelper.<br/>
	 ...
	 *             If the position hasn't been set at the construction of the this helper.
	 */
